...
if __name__ == "__main__":
    ...
    parser.add_argument('--class_num', type=int, help='trian class num', default=2)
    parser.add_argument('--pre_ckpt', type=str, help='pre-train model weights', default='None')
    parser.add_argument('--model_def', type=str, help='Model definition.', default='yolo_mobilev1')
    ...
    parser.add_argument('--output_size', type=int, help='net work output image size', default=(7, 10, 15, 20), nargs='+')
    ...
    parser.add_argument('--prune_end_epoch', type=int, help='prune epochs NOTE: must < train epochs', default=1)
    parser.add_argument('--prune_frequency', type=int, help='how many steps for prune once', default=1)
